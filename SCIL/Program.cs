...
namespace SCIL
{
    class Program
    {
        ...
        private static async Task AnalyzeFile(FileInfo fileInfo, IReadOnlyCollection<IFlixInstructionGenerator> emitters, ILogger logger, IModuleWriter moduleWriter)
        {
            // Logging
        ...
        private static async Task LoadZip(FileInfo fileInfo, IReadOnlyCollection<IFlixInstructionGenerator> emitters, ILogger logger, IModuleWriter moduleWriter)
        {
            // Open zip file
        ...
        private static Task ProcessAssymbly(Stream stream, IModuleWriter moduleWriter, IReadOnlyCollection<IFlixInstructionGenerator> emitters, ILogger logger)
        {
