...
namespace SCIL
{
    ...
    {
        public Configuration(IEnumerable<string> excludedModules, string outputPath, bool @async, IEnumerable<string> javaArgs, IEnumerable<string> flixArgs, bool showFlixWindow, bool noStringAnalysis)
        {
